...
// ── Screen registry ───────────────────────────────────────
const SCREENS = {
  home:    { render: renderHome,    label: 'Accueil'     },
  session: { render: renderSession, label: 'Séance'      },
  history: { render: renderHistory, label: 'Historique'  },
  profile: { render: renderProfile, label: 'Profil'      },
};
